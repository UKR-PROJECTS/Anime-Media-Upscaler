...
The best way to report a bug or request a new feature is to [open an issue](https://github.com/uikraft-hub/sharpify-gui/issues). Please use the provided templates to ensure you include all the necessary information.
...
*   [Open a pull request](https://github.com/uikraft-hub/sharpify-gui/pulls) to the `main` branch.
